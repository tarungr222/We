...
<?php include("pharmacytabs.html");?>
  <form action="" method="post" name="form1" id="form1">
    <table width="455" border="0" align="center">
      <tr>
        <td width="144"><span class="style3">Enter Patient name </span></td>
        <td width="207"><input type="text" name="s1" required/></td>
        <td width="23">&nbsp;</td>
      </tr>
      <tr>
        <td><span class="style3">Enter Patient id </span></td>
...
if(mysqli_num_rows($retval) > 0){  
 ...
 <table width="467" border="1" align="center">
   <tr>
     <td width="129" bgcolor="#CCCCCC"><div align="left"><strong>Name</strong></div></td>
     <td width="322" bgcolor="#FFFFFF"><span class="style1"><?php echo $row['name'] ?></span></td>
   </tr>
   <tr>
...
if(mysqli_num_rows($retval) > 0){  
 ...
 <table width="542" border="1" align="center">
   ...
   <tr>
     <td><div align="right"><strong>Purchase Status</strong></div></td>
     <td><?php echo $row['status'] ?></td>
   </tr>
    <tr>
     <td><div align="right"><strong>Total Bill Amount</strong></div></td>
